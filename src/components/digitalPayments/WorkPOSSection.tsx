...
const WorkPOSSection = () => {
  return (
    <section className="bg-[url('/assets/img/bdp/mobile-pos-bg.svg')] sm:bg-[url('/assets/img/bdp/pos-bg.svg')] h-[30rem]  sm:h-[80rem] bg-cover  bg-no-repeat   w-full pt-[8rem]  sm:pt-[25rem] bg-white sm:-mt-40 -mt-[7rem]  border z-10  ">
      <div className="custom-container ">
        <div className="flex flex-col items-center border h-full">
          ...
          <div className="border -mt-20  sm:-mt-[20rem] ">
