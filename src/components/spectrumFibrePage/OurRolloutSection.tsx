  ...
  return (
    <section className="bg-white">
      <div className="h-full w-full pt-10 pb-20 custom-container text-[#234222] md:hidden flex flex-col gap-4">
        <h1 className="text-[#0071BD] font-bold text-4xl">Our Rollout</h1>
        <div className="">
          ...
          Eastern and Northern Corridors of the country and Fibre infrastructure
          present in all the 16 regions of Ghana.
        </div>
