...
const SingleComponent = ({
  ...
  return (
    <div className="w-full border border-[#306FB7] px-8 md:px-10 rounded-[50px] h-[25rem] md:h-[30rem] flex justify-start flex-col text-left py-14 md:py-16 gap-14">
      <div className=" h-[30%]">
  ...
  return (
    <section className="py-20 bg-white">
      <div className="custom-container">
        <h1 className="text-[#0071BD] text-4xl md:text-7xl font-bold leading-snug md:text-center">
