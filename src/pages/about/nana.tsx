          ...
          <div className="custom-container  z-10  ">
            <div className="flex flex-col sm:flex-row gap-10 mx-3 sm:mx-28">
              <div className="w-full sm:w-[40%] flex flex-col items-end">
                <Image
                  src="https://res.cloudinary.com/diek2uivi/image/upload/v1686065715/bsl-website/bsl/board/nana-main_wla7ns.png"
                  blurDataURL="https://res.cloudinary.com/diek2uivi/image/upload/v1686065715/bsl-website/bsl/board/nana-main_wla7ns.png"
                  placeholder="blur"
                  alt="nana"
                  width={621}
                  height={952}
